...
const char *gengetopt_args_info_purpose = "Constructs a segment repeat-free founder block graph";

const char *gengetopt_args_info_usage = "Usage: founderblockgraph --input=MSA.fasta --output=MSA.index [--gap-limit=GAPLIMIT]\n[--graphviz-output=…]";
